 ...
 * Posts pagination.
 */
if ( ! function_exists( 'fitness_gymhouse_pagination_option' ) ) {
	function fitness_gymhouse_pagination_type() {
		$fitness_gymhouse_pagination_type = get_theme_mod( 'fitness_gymhouse_pagination_option', 'Default' );
		if ( $fitness_gymhouse_pagination_type == 'Default' ) {
