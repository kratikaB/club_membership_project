  ...
  <div class="abovecopyright">
    <div class="container">
      <div class="row">
        ...
        <div class="social-media col-lg-6 col-md-6 text-right">
          <?php if( get_theme_mod( 'ts_photography_facebook_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_facebook_url','' ) ); ?>"><i class="fab fa-facebook-square mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook','ts-photography' );?></span></a>
          <?php } ?>                       
          <?php if( get_theme_mod( 'ts_photography_twitter_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_twitter_url','' ) ); ?>"><i class="fab fa-twitter-square mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter','ts-photography' );?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_photography_youtube_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_youtube_url','' ) ); ?>"><i class="fab fa-youtube-square mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube','ts-photography' );?></span></a>
          <?php } ?> 
          <?php if( get_theme_mod( 'ts_photography_rss_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_rss_url','' ) ); ?>"><i class="fas fa-rss-square mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'RSS','ts-photography' );?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_photography_insta_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_insta_url','' ) ); ?>"><i class="fab fa-instagram mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram','ts-photography' );?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_photography_pint_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'ts_photography_pint_url','' ) ); ?>"><i class="fab fa-pinterest-square mr-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Pinterest','ts-photography' );?></span></a>
          <?php } ?>
        </div>
      </div>
