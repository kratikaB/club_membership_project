<?php
    ...
    if($ts_photography_slider == true){
    	$ts_photography_custom_css .='@media screen and (max-width:575px) {';
		$ts_photography_custom_css .='#scroll-top{';
			$ts_photography_custom_css .='display:block !important;';
		$ts_photography_custom_css .='} }';
	}else if($ts_photography_slider == false){
		$ts_photography_custom_css .='@media screen and (max-width:575px) {';
		$ts_photography_custom_css .='#scroll-top{';
    ...
    if($ts_photography_theme_lay == 'With Background'){
		$ts_photography_custom_css .='.page-box, #sidebar .widget,.woocommerce ul.products li.product, .woocommerce-page ul.products li.product,.front-page-content,.background-img-skin{';
			$ts_photography_custom_css .='background-color: #fff;';
		$ts_photography_custom_css .='}';
		$ts_photography_custom_css .='#sidebar{';
