...
<main role="main" id="maincontent">
  ...
  <?php if( get_theme_mod('ts_photography_slider_hide_show', false) != '' || get_theme_mod( 'ts_photography_responsive_slider', false) != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod('ts_photography_slider_speed_option', 3000)); ?>"> 
