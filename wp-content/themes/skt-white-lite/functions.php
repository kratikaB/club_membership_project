<?php
/**
 * The MAIN FUNCTIONS FILE for SKT White Lite
 *
...
function skt_complete_import_files() {
	return array(
		array(
			'import_file_name'             => 'Import SKT White Lite Demo',
...
function theme_register_my_members_menu() {
...
add_action( 'after_setup_theme', 'theme_register_my_members_menu' );