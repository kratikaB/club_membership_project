...
if ( ! class_exists( 'Guten_Blog_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Guten_Blog_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'guten-blog-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'guten-blog-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
